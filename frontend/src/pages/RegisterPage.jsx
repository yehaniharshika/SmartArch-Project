...
export default function RegisterPage() {
  ...
  const strengthColors = ["bg-stone-200", "bg-red-400", "bg-amber-400", "bg-emerald-400", "bg-emerald-500"];
    ...
    <div className="min-h-screen bg-arch-cream flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-stone-900 flex-col justify-between
        ...
        <div className="relative space-y-6">
          ...
          >
            Everything you need<br />to analyse floor plans.
          </h2>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 overflow-y-auto">
        <div className="w-full max-w-sm space-y-7 page-enter">
          ...
          <div className="space-y-1">
            ...
            <p className="font-sans text-sm text-stone-500">Architect registration.</p>
          </div>
          ...
          <p className="font-sans text-sm text-stone-500 text-center">
            ...
            <Link to="/login" className="text-bronze-DEFAULT hover:underline font-medium">
              Sign in
            </Link>
          </p>
